...
try:
    ...
    req = models.ReplaceProjectRequest()
    ...
    model = models.Model()
    model.AssetList = ["ASHARE", "USSHARE", "HKSHARE", "ABS_RETURN", "OIL", "GOLD", "TREASURY", "CN_CREDIT",
                       "GLOBAL_DEBT", "CASH"]
    ...
    resp = client.ReplaceProject("a8fa4a80-7a62-11ea-b95f-ee8a56efc5ad", req)
